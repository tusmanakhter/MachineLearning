...
if testing_file and training_file:
    ...
    if not (results_file and model_file):
        parser.error("Need testing, results, and model file arguments")
    else:
        machine_learning.test(testing_file, results_file, model_file)
elif training_file:
    if not (validation_file and results_file and save_model_file and (decision or naive or neural)):
        ...
        machine_learning.train(classifier_type, training_file, validation_file, results_file, save_model_file)
else:
